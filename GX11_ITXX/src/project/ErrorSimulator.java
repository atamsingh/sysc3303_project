...
public class ErrorSimulator {
	...
	boolean delay, dup, lose; errorpacket;
	byte eblocktype;
	...
	public ErrorSimulator(int verbose,int error) {
		...
		if(error==0) {
			delay = false; dup = false; lose = false;//errorpacket = true;
		}else if(error == 1) {
			delay = false; dup = false; lose = true;//errorpacket = true;
		}else if(error == 2) {
			delay = true; dup = false; lose = false;//errorpacket = true;
